\chapter{Introducción}
    ...
    El ámbito del entrenamiento deportivo de competición, específicamente en disciplinas invernales como el esquí alpino, presenta una dinámica operativa altamente compleja. A diferencia de otros deportes de interior o con instalaciones estables, la gestión de un club de esquí está condicionada por factores variables como los constantes cambios en las condiciones meteorológicas y de la nieve, y la dispersión geográfica de las estaciones de esquí.
    ...
    \hfill \break
        A continuación, se muestran ejemplos de las 5 aplicaciones mencionadas para que puedan ser visualizadas:
        ...
        \begin{figure}[htbp]
            ...
            \begin{subfigure}{.48\textwidth}
                \centering
                \includegraphics[width=.5\linewidth, height=1.1\linewidth]{imagenes/sportEasy.jpeg}
                \caption{SportEasy \protect\cite{SportEasy}}
                \label{fig:sporteasy_interface}            
            \end{subfigure}\hfill
            \begin{subfigure}{.48\textwidth}
                \centering
                \includegraphics[width=.5\linewidth, height=1.1\linewidth]{imagenes/Playoff.jpeg}
            ...
            \begin{subfigure}{.48\textwidth}
                \centering
                \includegraphics[width=.5\linewidth, height=1.1\linewidth]{imagenes/TeamSnap.jpeg}
                \caption{TeamSnap \protect\cite{TeamSnap}}
                \label{fig:teamsnap_interface}            
            \end{subfigure}\hfill
            \begin{subfigure}{.48\textwidth}
                \centering
                \includegraphics[width=.5\linewidth, height=1.1\linewidth]{imagenes/Sprongo.jpeg}
            ...
            \begin{subfigure}{\textwidth}
                \centering
                \includegraphics[width=.33\linewidth, height=0.4\linewidth]{imagenes/Onesporter.jpeg}
    ...
    En consecuencia, la integración de estos módulos tecnológicos permitirá transformar la gestión operativa del club y el seguimiento de los deportistas en un proceso centralizado, eficiente y automatizado. Asimismo, garantizará la transparencia y accesibilidad de la información tanto para el cuerpo técnico como para los tutores legales.